...
\begin{itemize}[noitemsep,nolistsep, label = {-}]
	\item Communicated directly with Google and made key decisions on critical aspects of \myhy{https://sites.google.com/view/ignitecs/home}{the program}.
...
\begin{itemize}[noitemsep,nolistsep, label={-}]
	\item Planned and implemented biweekly outreach events for \myhy{https://uf-ace.com/}{a club} with a reach of nearly 1000 members.
