...
\begin{document}
	...
	\section*{EDUCATION}
		...
		\hfill\textbf{GPA: UPDATE\_ME/4.0}
	...
	\section*{TECHNICAL SKILLS AND INTERESTS}
		...
		\begin{itemize}[noitemsep,nolistsep, label={}]
			\item \textbf{Back-End}                    \tabto*{5cm} Java, C\#, Python, SQL, C++
			\item \textbf{Miscellaneous}             \tabto*{5cm} OCaml, ANTLR, MATLAB/Octave, C, VHDL, AVR Assembly
			\item \textbf{Frameworks \& Tools}  \tabto*{5cm} Git, ASP.NET
